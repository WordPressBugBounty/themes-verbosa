...
function verbosa_get_option_defaults() {
	...
	"verbosa_menutitle"		=> 0, // 1=use assigned menu title, 0=use legacy 'menu' label
	...
	"verbosa_lpslidercta1text"	=> _x('Learn More','Slider CTA Text 1 default value','verbosa'),
	...
	"verbosa_textalign"			=> "inherit",
	"verbosa_paragraphspace"	=> 1.0,
	"verbosa_parindent"			=> 0.0,
	"verbosa_lineheight"		=> 1.8,
	...
	"verbosa_excerptcont"		=> _x('Continue reading','Blog post excerpts default read more label','verbosa'),
